// File: /lessons/film-music/lesson5/Lesson5.jsx
...
import { Monitor, Video, Film, Clock, X, Play } from 'lucide-react';
import { getDatabase, ref, onValue } from 'firebase/database';

// Config
import { fmLesson5Config, lessonStages, getActivityForStage } from './Lesson5config';
...
const LESSON_PROGRESS_KEY = 'fm-lesson5-progress';
const LESSON_TIMER_KEY = 'fm-lesson5-timer';
...
const Lesson5 = () => {
  ...
  if (sessionMode.isSessionMode && effectiveRole === 'student') {
    ...
    // Summary/discussion slides: watch the main screen
    ...
    const activity = fmLesson5Config.activities.find(a => a.type === activityType);
