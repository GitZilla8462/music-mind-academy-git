// File: /lessons/film-music/lesson3/Lesson3.jsx
...
// Config
import { fmLesson3Config, lessonStages, getActivityForStage } from './Lesson3config';
...
const LESSON_PROGRESS_KEY = 'fm-lesson3-progress';
const LESSON_TIMER_KEY = 'fm-lesson3-timer';
...
const Lesson3 = () => {
  ...
  if (sessionMode.isSessionMode && effectiveRole === 'student') {
    ...
    const activity = fmLesson3Config.activities.find(a => a.type === activityType);
