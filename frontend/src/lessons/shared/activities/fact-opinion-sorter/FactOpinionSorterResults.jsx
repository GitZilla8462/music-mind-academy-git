// File: /src/lessons/shared/activities/fact-opinion-sorter/FactOpinionSorterResults.jsx
// Fact or Opinion Sorter - Results Leaderboard (Teacher Presentation View)
// Shows podium + full leaderboard after the game finishes
...
const FactOpinionSorterResults = ({ sessionData }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(studentsRef, (snapshot) => {
      ...
      const list = Object.entries(data)
        .filter(([, s]) => (s.displayName || s.playerName || s.name) && s.factOpinionScore != null)
        .map(([id, s]) => ({
          id,
...
export default FactOpinionSorterResults;
