...
const LayerDetectivePartnerGame = ({ onComplete, viewMode = false }) => {
  ...
  const loopsByMood = {
    ...
    Scary: [
      { name: 'Scary Percussion 1', category: 'Percussion', file: '/projects/film-music-score/loops/Scary Percussion 1.m4a', color: '#EF4444' },
      { name: 'Scary Percussion 2', category: 'Percussion', file: '/projects/film-music-score/loops/Scary Percussion 2.m4a', color: '#DC2626' },
      { name: 'Scary Brass 1', category: 'Brass', file: '/projects/film-music-score/loops/Scary Brass 1.m4a', color: '#F59E0B' },
      { name: 'Scary Strings 1', category: 'Strings', file: '/projects/film-music-score/loops/Scary Strings 1.m4a', color: '#10B981' },
      { name: 'Scary Strings 2', category: 'Strings', file: '/projects/film-music-score/loops/Scary Strings 2.m4a', color: '#059669' },
      { name: 'Scary Strings 3', category: 'Strings', file: '/projects/film-music-score/loops/Scary Strings 3.m4a', color: '#047857' },
      { name: 'Scary Strings 4', category: 'Strings', file: '/projects/film-music-score/loops/Scary Strings 4.m4a', color: '#065F46' },
      { name: 'Scary Synth 1', category: 'Synth', file: '/projects/film-music-score/loops/Scary Synth 1.m4a', color: '#8B5CF6' },
      { name: 'Scary Synth 2', category: 'Synth', file: '/projects/film-music-score/loops/Scary Synth 2.m4a', color: '#7C3AED' },
      { name: 'Scary Synth 3', category: 'Synth', file: '/projects/film-music-score/loops/Scary Synth 3.m4a', color: '#6D28D9' },
      { name: 'Scary Synth 4', category: 'Synth', file: '/projects/film-music-score/loops/Scary Synth 4.m4a', color: '#5B21B6' },
      { name: 'Scary Bass 1', category: 'Bass', file: '/projects/film-music-score/loops/Scary Bass 1.m4a', color: '#3B82F6' },
      { name: 'Scary Bass 2', category: 'Bass', file: '/projects/film-music-score/loops/Scary Bass 2.m4a', color: '#2563EB' },
      { name: 'Scary Bass 3', category: 'Bass', file: '/projects/film-music-score/loops/Scary Bass 3.m4a', color: '#1D4ED8' }
    ],
    Upbeat: [
