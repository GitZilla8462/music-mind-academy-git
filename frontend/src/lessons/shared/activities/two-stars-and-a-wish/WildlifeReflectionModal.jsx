...
const WildlifeReflectionModal = ({
  ...
  return (
    <div data-reflection-modal className={`fixed top-4 left-4 z-[100] w-96 max-h-[calc(100dvh-2rem)] flex flex-col bg-white rounded-xl shadow-2xl border-2 border-green-200 ${isChromebook ? 'chromebook-hide-cursor' : ''}`} style={{ maxHeight: 'calc(100dvh - 2rem)' }}>
      {/* Header */}
