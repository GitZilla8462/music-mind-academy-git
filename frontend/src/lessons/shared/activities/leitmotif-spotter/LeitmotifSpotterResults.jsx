// Leitmotif Spotter - Results Leaderboard (Teacher Presentation View)
...
const LeitmotifSpotterResults = ({ sessionData }) => {
  ...
  return (
    <div className="min-h-screen h-full flex flex-col bg-gradient-to-br from-indigo-900 via-purple-900 to-violet-900 text-white overflow-hidden">
      <div className="text-center py-6">
        ...
        <h1 className="text-5xl font-black mb-2">Leitmotif Spotter Results</h1>
          ...
          <div className="flex justify-center items-end gap-4 mb-8">
            {topThree[1] && (
              <div className="flex flex-col items-center">
                ...
                >{topThree[1].playerEmoji || topThree[1].name.charAt(0)}</div>
            ...
            {topThree[0] && (
              <div className="flex flex-col items-center">
                ...
                >{topThree[0].playerEmoji || topThree[0].name.charAt(0)}</div>
            ...
            {topThree[2] && (
              <div className="flex flex-col items-center">
                ...
                >{topThree[2].playerEmoji || topThree[2].name.charAt(0)}</div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 overflow-y-auto max-h-64">
              {rest.map((student, idx) => (
                <div key={student.id} className="flex items-center gap-2 p-2 rounded-xl bg-white/5">
                  ...
                  >{student.playerEmoji || student.name.charAt(0)}</div>
...
export default LeitmotifSpotterResults;
