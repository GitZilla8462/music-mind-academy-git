  ...
  return (
    <div className="min-h-screen h-full flex flex-col bg-gradient-to-br from-indigo-900 via-purple-900 to-violet-900 text-white overflow-hidden">
      ...
      <div className="text-center py-6">
        ...
        <h1 className="text-5xl font-black mb-2">Rondo Form Game Results</h1>
          ...
          <div className="flex justify-center items-end gap-4 mb-8">
            ...
            {topThree[1] && (
              <div className="flex flex-col items-center">
                <div className="w-24 h-24 rounded-full flex items-center justify-center text-4xl mb-2 ring-4 ring-gray-300" style={{ backgroundColor: topThree[1].playerColor }}>
            ...
            {topThree[0] && (
              <div className="flex flex-col items-center">
                <div className="w-32 h-32 rounded-full flex items-center justify-center text-5xl mb-2 ring-4 ring-yellow-400 animate-pulse" style={{ backgroundColor: topThree[0].playerColor }}>
            ...
            {topThree[2] && (
              <div className="flex flex-col items-center">
                <div className="w-20 h-20 rounded-full flex items-center justify-center text-3xl mb-2 ring-4 ring-amber-600" style={{ backgroundColor: topThree[2].playerColor }}>
          ...
          <div className="flex-1 bg-black/20 rounded-2xl p-4 overflow-hidden">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 overflow-y-auto max-h-64">
              {rest.map((student, idx) => (
                <div key={student.id} className="flex items-center gap-2 p-2 rounded-xl bg-white/5">
                  <span className="w-8 text-center font-bold text-sm text-white/70">#{idx + 4}</span>
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold text-white" style={{ backgroundColor: student.playerColor }}>
...
export default RondoFormGameResults;
