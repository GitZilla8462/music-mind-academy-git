  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(studentsRef, (snapshot) => {
      ...
      const list = Object.entries(data)
        .filter(([, s]) => (s.displayName || s.playerName || s.name) && s.sectionSpotterScore != null)
        .map(([id, s]) => ({
        id,
  ...
  return (
    <div className="min-h-screen h-full flex flex-col bg-gradient-to-br from-orange-900 via-amber-900 to-yellow-900 text-white overflow-hidden">
      ...
      <div className="text-center py-6">
        ...
        <h1 className="text-5xl font-black mb-2">Section Spotter Results</h1>
...
export default SectionSpotterResults;
