// Song Recipe Presentation View - Live leaderboard for projector
// Shows all students playing with scores, similar to Layer Detective
// src/lessons/shared/activities/song-recipe/SongRecipePresentationView.jsx

import React, { useState, useEffect } from 'react';
import { Trophy, Users, Clock, ChefHat, Star } from 'lucide-react';

const SongRecipePresentationView = ({ sessionData, onEndActivity }) => {
  const [leaderboard, setLeaderboard] = useState([]);
  const [timeElapsed, setTimeElapsed] = useState(0);
  const [startTime] = useState(Date.now());
  
  // Update leaderboard with ALL students
  useEffect(() => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-orange-600 via-red-600 to-pink-600 text-white p-6 overflow-hidden">
      {/* Header */}
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-5xl font-bold flex items-center mb-2">
              <ChefHat className="mr-4" size={56} />
              Order the Recipe
            </h1>
            <p className="text-2xl opacity-80">
              Build the perfect song structure!
            </p>
          </div>
            ...
            <div className="bg-white/10 px-6 py-4 rounded-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm opacity-80">Chefs</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            {leaderboard.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-2xl">Waiting for chefs to start...</p>
              </div>
            )}
          </div>
...
export default SongRecipePresentationView;