  ...
  const assignmentPanelContent = !viewMode && !isExplorationMode ? (
    <div className="h-full bg-gray-800 text-white p-2 flex flex-col gap-2 overflow-y-auto">
      ...
      <div className="text-center">
        <h3 className="font-bold text-base mb-1">The School Beneath</h3>
        <p className="text-xs text-gray-300">Create a mysterious underwater score</p>
      </div>
      ...
      <div className="space-y-1">
        ...
        >
          {allRequirementsMet ? '✓ Submit & Unlock All Loops' : 'Complete Requirements First'}
        </button>
