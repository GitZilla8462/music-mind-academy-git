...
const SchoolBeneathActivity = ({ 
  ...
  const handleLoopPlaced = (loopData, trackIndex, startTime) => {
    ...
    if (!isExplorationMode && loopData.mood !== 'Mysterious') {
      ...
      setSaveMessage('âš  Only Mysterious loops allowed!');
  ...
  // ============================================================================
  // RENDER: BONUS GAME (after reflection completion)
  // ============================================================================
        ...
        <div className="flex-1 overflow-hidden">
          <NameThatLoopActivity 
            onComplete={() => {
              ...
              // Stay in bonus mode - teacher will advance when ready
            }}
          />
        </div>
      </div>
  ...
  return (
    <div className="h-full flex flex-col bg-gray-900">
      ...
      {/* Reflection Modal - Shows when in reflection stage */}
