// File: /lessons/music-journalist/lesson5/Lesson5.jsx
// Music Journalist - Lesson 5: Press Day
...
const LESSON_PROGRESS_KEY = 'music-journalist-lesson5-progress';
const LESSON_TIMER_KEY = 'music-journalist-lesson5-timer';
...
const Lesson5 = () => {
  ...
  // Preview mode: use local stage state
  ...
  if (isPreviewMode && isTeacher) {
    return (
      <TeacherLessonView
          config={{ ...lesson5Config, getActivityForStage }}
  ...
  if (viewSavedMode || viewReflectionMode) {
    return (
      <ActivityRenderer
        activity={{ type: viewReflectionMode ? 'mj-peer-feedback' : 'mj-presentation', id: 'saved-view' }}
