// File: /lessons/music-journalist/lesson4/Lesson4.jsx
// Music Journalist - Lesson 4: Build Your Story
...
const LESSON_PROGRESS_KEY = 'music-journalist-lesson4-progress';
const LESSON_TIMER_KEY = 'music-journalist-lesson4-timer';
  ...
  if (!currentActivity) {
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-gray-900 text-white">
        ...
        <p className="text-xl text-gray-400 mb-8">Your presentation is ready for Press Day!</p>
        <button
