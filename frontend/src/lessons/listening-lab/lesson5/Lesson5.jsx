// File: /lessons/listening-lab/lesson5/Lesson5.jsx
// Work Time + Gallery Circle
...
const LESSON_PROGRESS_KEY = 'listening-lab-lesson5-progress';
const LESSON_TIMER_KEY = 'listening-lab-lesson5-timer';
  ...
  if (!currentActivity) {
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-gray-900 text-white">
        ...
        <p className="text-xl text-gray-400 mb-8">Amazing work completing The Listening Lab!</p>
        <button
