// File: /lessons/listening-lab/lesson2/Lesson2.jsx
// Woodwinds & Tempo
...
const LESSON_PROGRESS_KEY = 'listening-lab-lesson2-progress';
const LESSON_TIMER_KEY = 'listening-lab-lesson2-timer';
...
const Lesson2 = () => {
  ...
  if (isPreviewMode && isTeacher) {
    return (
      <TeacherLessonView
          config={{ ...lesson2Config, getActivityForStage }}
  ...
  if (!currentActivity) {
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-gray-900 text-white">
        ...
        <p className="text-xl text-gray-400 mb-8">Great job learning about the orchestra!</p>
        <button
