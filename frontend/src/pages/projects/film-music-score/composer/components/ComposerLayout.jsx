// composer/components/ComposerLayout.jsx - Main layout with resizable panels
...
const ComposerLayout = ({
  ...
  return (
    ...
    >
      ...
      {/* Center Panel - Video and Timeline */}
      <div className="flex-1 flex flex-col overflow-hidden min-h-0">
        {/* Video Player */}
        <div className="flex-shrink-0" style={{ height: tutorialMode ? '300px' : `${topPanelHeight}px` }}>
          <div 
          ...
          >
            <div className="h-full">
              <VideoPlayer
                ...
                maxHeight={tutorialMode ? 268 : topPanelHeight - 32}
                tutorialMode={tutorialMode}
              />
            </div>
          </div>
