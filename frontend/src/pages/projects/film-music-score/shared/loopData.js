// Loop data for Name That Loop activity
// All loops are located in /projects/film-music-score/loops/
...
export const getCategories = () => {
  return [...new Set(loopsData.map(loop => loop.category))];
};

// Helper function to get loops by category
export const getLoopsByCategory = (category) => {
  return loopsData.filter(loop => loop.category === category);
};

// Helper function to get unique instruments
export const getInstruments = () => {
  return [...new Set(loopsData.map(loop => loop.instrument))];
};
...
// ✅ THIS IS THE FUNCTION useComposerEffects.js NEEDS
export const getVideoById = (videoId) => {
  return videos.find(video => video.id === videoId);
};

// Helper function to get videos by category (if needed)
