        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <button
                onClick={onRestart}
                className="p-1.5 text-gray-400 hover:text-white hover:bg-gray-700 rounded transition-all duration-200 group"
          ...
          {/* Center: Main Transport Buttons - Compact */}
          <div className="flex items-center space-x-2 bg-gray-800/50 rounded-lg p-1">
            ...
            <button
              ...
              className="p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg shadow-blue-600/30"
