    ...
    <div className="bg-gray-800 px-3 py-1 border-b border-gray-700 flex-shrink-0">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-2 bg-gray-700 rounded-lg px-2 py-0.5">
            <button
            ...
            <div className="flex items-center space-x-1.5">
              <span className="text-xs text-gray-400 w-7">25%</span>
              <input
                type="range"
                min="0.25"
                max="4.0"
                ...
                className="w-20 h-1 bg-gray-600 rounded-lg appearance-none cursor-pointer zoom-slider"
                style={{
              ...
              />
              <span className="text-xs text-gray-400 w-8">400%</span>
            </div>
