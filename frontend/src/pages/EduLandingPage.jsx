...
const EduLandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      {/* Sign-in Error Toast */}
      {signInError && (
        <div className="fixed left-1/2 -translate-x-1/2 z-50 bg-red-100 border border-red-400 text-red-700 px-6 py-3 rounded-lg shadow-lg flex items-center gap-3" style={{ top: 'max(5rem, env(safe-area-inset-top, 5rem))' }}>
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <svg className={`w-5 h-5 ${isSigningIn ? 'animate-spin' : ''}`} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
              {isSigningIn ? (
                <>
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
      ...
      <section className="py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            {isSigningIn ? 'Signing in...' : 'Enter Music Room Tools'}
          </button>
        </div>
      </section>
