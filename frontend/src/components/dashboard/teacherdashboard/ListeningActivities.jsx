// /src/components/dashboard/ListeningActivities.jsx - FIXED DEMO NAVIGATION
import React, { useState, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom'; // useNavigate already imported
import { 
  Headphones, 
  Play, 
  ArrowLeft,
...
// Listening Skills Category Definition
const LISTENING_SKILLS_CATEGORY = {
  id: 'listening-skills',
  title: 'Listening Skills',
  icon: <Headphones className="w-6 h-6" />,
  color: 'bg-indigo-500',
  description: 'Aural pattern recognition and listening exercises',
  skillLevels: {
    'beginner': {
      id: 'beginner',
      title: 'Beginner',
      ...
      exercises: [
        { id: 1, title: 'Exercise 1', difficulty: 'Beginner', status: '0/8', description: 'Do-Re pattern matching' },
        { id: 2, title: 'Exercise 2', difficulty: 'Beginner', status: '0/8', description: 'Do-Re-Mi pattern matching' },
        { id: 3, title: 'Exercise 3', difficulty: 'Beginner', status: '0/8', description: 'Do-Re-Mi-Fa pattern matching' },
        { id: 4, title: 'Exercise 4', difficulty: 'Beginner', status: '0/8', description: 'Do-Re-Mi-Fa-Sol pattern matching' }
      ]
    },
    'level-1': {
      id: 'level-1',
      ...
      exercises: [
        { 
          ...
          status: '0/1', 
          description: 'C Major',
          detailedDescription: 'Listening exercise with Do through Sol using quarter and half notes in C Major'
        },
        { 
          id: 2, 
          title: 'Exercise 2', 
          ...
          status: '0/16', 
          description: 'F Major',
          detailedDescription: 'Listening exercise with Do through Sol using quarter and half notes in F Major'
        }
      ]
    },
    'level-2': {
      ...
      exercises: [
        { 
          ...
          status: '0/20', 
          description: 'C Major',
          detailedDescription: 'Listening exercise with Do through La using quarter notes, half notes, and quarter rests in C Major. Includes Do-Mi-Sol patterns and rhythmic complexity.'
        },
        { 
          id: 2, 
          title: 'Exercise 2', 
          ...
          status: '0/20', 
          description: 'F Major',
          detailedDescription: 'Listening exercise with Do through La using quarter notes, half notes, and quarter rests in F Major. Includes Do-Mi-Sol patterns and rhythmic complexity.'
        },
        { 
          id: 3, 
          title: 'Exercise 3', 
          ...
          status: '0/20', 
          description: 'G Major',
          detailedDescription: 'Listening exercise with Do through La using quarter notes, half notes, and quarter rests in G Major. Includes Do-Mi-Sol patterns and rhythmic complexity.'
        },
      ]
    },
    'level-3': {
...
const ListeningActivities = ({ 
  ...
  const navigate = useNavigate(); // Already imported, this is the key line
  const params = useParams();
  
  // Get skill level from URL params or prop
  const { level } = params;
  const [selectedSkillLevel, setSelectedSkillLevel] = useState(level || initialSkillLevel || null);
  const [selectedExercises, setSelectedExercises] = useState([]);
  const [showPreview, setShowPreview] = useState(null);

  // Update skill level when URL changes
  useEffect(() => {
    setSelectedSkillLevel(level || initialSkillLevel || null);
  }, [level, initialSkillLevel]);

  const category = LISTENING_SKILLS_CATEGORY;

  // FIXED DEMO EXERCISE FUNCTION - USES REACT ROUTER NAVIGATION
  const handleDemoExercise = (exercise) => {
    let exerciseUrl;
    if (exercise.id === 1 && selectedSkillLevel === 'beginner') {
      exerciseUrl = `/listening-1`;
    } else if (exercise.id === 2 && selectedSkillLevel === 'beginner') {
      exerciseUrl = `/listening-2`;
    } else if (exercise.id === 3 && selectedSkillLevel === 'beginner') {
      exerciseUrl = `/listening-3`;
    } else if (exercise.id === 4 && selectedSkillLevel === 'beginner') {
      exerciseUrl = `/listening-4`;
    } else if (exercise.id === 1 && selectedSkillLevel === 'level-1') {
      exerciseUrl = `/lvl1-listening-1`;
    } else if (exercise.id === 2 && selectedSkillLevel === 'level-1') {
      exerciseUrl = `/lvl1-listening-2`;
    } else if (exercise.id === 1 && selectedSkillLevel === 'level-2') {
      exerciseUrl = `/lvl2-listening-1`;
    } else if (exercise.id === 2 && selectedSkillLevel === 'level-2') {
      exerciseUrl = `/lvl2-listening-2`;
    } else if (exercise.id === 3 && selectedSkillLevel === 'level-2') {
      exerciseUrl = `/lvl2-listening-3`;
    } else if (exercise.id === 1 && selectedSkillLevel === 'level-3') {
      exerciseUrl = `/lvl3-listening-1`;
    } else if (exercise.id === 2 && selectedSkillLevel === 'level-3') {
      exerciseUrl = `/lvl3-listening-2`;
    } else if (exercise.id === 3 && selectedSkillLevel === 'level-3') {
      exerciseUrl = `/lvl3-listening-3`;
    } else if (exercise.id === 4 && selectedSkillLevel === 'level-3') {
      exerciseUrl = `/lvl3-listening-4`;
    } else if (exercise.id === 1 && selectedSkillLevel === 'level-4') {
      exerciseUrl = `/lvl4-listening-1`;
    } else if (exercise.id === 2 && selectedSkillLevel === 'level-4') {
      exerciseUrl = `/lvl4-listening-2`;
    } else if (exercise.id === 3 && selectedSkillLevel === 'level-4') {
      exerciseUrl = `/lvl4-listening-3`;
    } else {
      exerciseUrl = `/listening-${exercise.id}`;
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          {['beginner', 'level-1', 'level-2'].map((levelId) => {
            ...
            return (
              <div
                key={skillLevel.id}
                onClick={() => setSelectedSkillLevel(skillLevel.id)} // FIXED: Use local state instead of navigate
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            <button
              onClick={() => {
                setSelectedSkillLevel(null); // FIXED: Go back to skill level selection
              }}
              className="flex items-center space-x-2 text-blue-600 hover:text-blue-800"
            >
              <ArrowLeft className="w-4 h-4" />
              <span>Back to Listening Skills</span>
            </button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                {getListeningPreviewItems(showPreview)}
              </ul>
            </div>
  ...
  // Helper function for listening preview items
  const getListeningPreviewItems = (exercise) => {
    if (exercise.id === 1 && selectedSkillLevel === 'beginner') {
      return [
        <li key="1">• Listen to Do-Re musical patterns</li>,
        <li key="2">• Match audio to visual notation</li>,
        <li key="3">• Select from 4 pattern choices (A, B, C, D)</li>,
        <li key="4">• Complete 8 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 2 && selectedSkillLevel === 'beginner') {
      return [
        <li key="1">• Listen to Do-Re-Mi musical patterns</li>,
        <li key="2">• Match audio to visual notation</li>,
        <li key="3">• Select from 4 pattern choices (A, B, C, D)</li>,
        <li key="4">• Complete 8 pattern recognition exercises</li>
      ];
      ...
      return [
        <li key="1">• Listen to Do-Re-Mi-Fa musical patterns (8 notes each)</li>,
        <li key="2">• Match audio to visual notation</li>,
        <li key="3">• Select from 4 pattern choices (A, B, C, D)</li>,
        <li key="4">• Complete 8 pattern recognition exercises</li>
      ];
      ...
      return [
        <li key="1">• Listen to Do-Re-Mi-Fa-Sol musical patterns (8 notes each)</li>,
        <li key="2">• Match audio to visual notation</li>,
        <li key="3">• Select from 4 pattern choices (A, B, C, D)</li>,
        <li key="4">• Complete 8 pattern recognition exercises</li>
      ];
      ...
      return [
        <li key="1">• Listen to musical patterns with Do through Sol</li>,
        <li key="2">• Work with quarter and half note rhythms</li>,
        <li key="3">• Match audio to visual notation in C Major</li>,
        <li key="4">• Select from 4 pattern choices (A, B, C, D)</li>,
        <li key="5">• Complete pattern recognition exercise</li>
      ];
    } else if (exercise.id === 2 && selectedSkillLevel === 'level-1') {
      return [
        <li key="1">• Listen to musical patterns with Do through Sol</li>,
        <li key="2">• Work with quarter and half note rhythms</li>,
        <li key="3">• Match audio to visual notation in F Major</li>,
        <li key="4">• Select from 4 pattern choices (A, B, C, D)</li>,
        <li key="5">• Complete 16 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 1 && selectedSkillLevel === 'level-2') {
      return [
        <li key="1">• Listen to musical patterns with Do through La</li>,
        <li key="2">• Work with quarter notes, half notes, and quarter rests</li>,
        <li key="3">• Practice Do-Mi-Sol patterns within the exercises</li>,
        <li key="4">• Match audio to visual notation in C Major</li>,
        <li key="5">• Complete approximately 20 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 2 && selectedSkillLevel === 'level-2') {
      return [
        <li key="1">• Listen to musical patterns with Do through La</li>,
        <li key="2">• Work with quarter notes, half notes, and quarter rests</li>,
        <li key="3">• Practice Do-Mi-Sol patterns within the exercises</li>,
        <li key="4">• Match audio to visual notation in F Major</li>,
        <li key="5">• Complete approximately 20 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 3 && selectedSkillLevel === 'level-2') {
      return [
        ...
        <li key="2">• Work with quarter notes, half notes, and quarter rests</li>,
        <li key="3">• Practice Do-Mi-Sol patterns within the exercises</li>,
        <li key="4">• Match audio to visual notation in G Major</li>,
        <li key="5">• Complete approximately 20 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 1 && selectedSkillLevel === 'level-3') {
      return [
        <li key="1">• Listen to musical patterns with Do through La</li>,
        <li key="2">• Work with quarter notes, half notes, and eighth note pairs</li>,
        <li key="3">• Practice stepwise eighth note patterns</li>,
        <li key="4">• Match audio to visual notation in C Major with 4/4 time</li>,
        <li key="5">• Complete approximately 23 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 2 && selectedSkillLevel === 'level-3') {
      return [
        <li key="1">• Listen to musical patterns with Do through La</li>,
        <li key="2">• Work with quarter notes, half notes, and eighth note pairs</li>,
        <li key="3">• Practice stepwise eighth note patterns in F Major</li>,
        <li key="4">• Match audio to visual notation in F Major with 4/4 time</li>,
        <li key="5">• Complete approximately 23 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 3 && selectedSkillLevel === 'level-3') {
      return [
        <li key="1">• Listen to musical patterns with Do through La</li>,
        <li key="2">• Work with quarter notes, half notes, and eighth note pairs</li>,
        <li key="3">• Practice stepwise eighth note patterns in G Major</li>,
        <li key="4">• Match audio to visual notation in G Major with 4/4 time</li>,
        <li key="5">• Complete approximately 23 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 4 && selectedSkillLevel === 'level-3') {
      return [
        <li key="1">• Listen to musical patterns with Do only</li>,
        <li key="2">• Work with quarter notes in 3/4 time signature</li>,
        <li key="3">• Practice simple rhythmic patterns with all Do notes</li>,
        <li key="4">• Match audio to visual notation in C Major with 3/4 time</li>,
        <li key="5">• Complete 24 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 1 && selectedSkillLevel === 'level-4') {
      return [
        <li key="1">• Listen to musical patterns with Do through Ti</li>,
        <li key="2">• Work with quarter notes, half notes, and eighth note pairs</li>,
        <li key="3">• Practice Do-Mi-Sol and Sol-La-Ti-Do sequences</li>,
        <li key="4">• Experience dynamics markings (forte/piano)</li>,
        <li key="5">• Match audio to visual notation in C Major with 4/4 time</li>,
        <li key="6">• Complete approximately 25 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 2 && selectedSkillLevel === 'level-4') {
      return [
        <li key="1">• Listen to musical patterns with Do through Ti</li>,
        <li key="2">• Work with quarter notes, half notes, and eighth note pairs</li>,
        <li key="3">• Practice Do-Mi-Sol and Sol-La-Ti-Do sequences in F Major</li>,
        <li key="4">• Experience dynamics markings (forte/piano)</li>,
        <li key="5">• Match audio to visual notation in F Major with 4/4 time</li>,
        <li key="6">• Complete approximately 25 pattern recognition exercises</li>
      ];
    } else if (exercise.id === 3 && selectedSkillLevel === 'level-4') {
      return [
        <li key="1">• Listen to musical patterns with Do through Ti</li>,
        <li key="2">• Work with quarter notes, half notes, and eighth note pairs</li>,
        <li key="3">• Practice Do-Mi-Sol and Sol-La-Ti-Do sequences in G Major</li>,
        <li key="4">• Experience dynamics markings (forte/piano)</li>,
        <li key="5">• Match audio to visual notation in G Major with 4/4 time</li>,
        <li key="6">• Complete approximately 25 pattern recognition exercises</li>
      ];
    } else {
      return [
        <li key="1">• Listen to musical patterns</li>,
        <li key="2">• Match audio to visual notation</li>,
        <li key="3">• Complete pattern recognition exercises</li>,
...
export default ListeningActivities;