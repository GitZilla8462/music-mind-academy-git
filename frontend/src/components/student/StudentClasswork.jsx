...
const StudentClasswork = () => {
  ...
  // Build flat assignment list per unit (no lesson sub-grouping)
        ...
        return (
          <div key={unit.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            >
              ...
              <span className="text-xs text-gray-400">{unit.assignments.length} assignment{unit.assignments.length !== 1 ? 's' : ''}</span>
            </button>

            {/* Flat assignment list */}
            {isExpanded && (
                  ...
                  return (
                    <div key={assignment.key}>
                      ...
                      >
                        ...
                        {/* Assignment name + lesson context */}
                        <div className="flex-1 min-w-0">
                          <div className="text-sm font-medium text-gray-900 truncate">{assignment.name}</div>
                          <div className="text-xs text-gray-400 truncate">{assignment.lessonName}</div>
                        </div>
