// /src/components/exercises/2.listening_skills/alevel3/Lvl3SolfegeListening2.jsx - F MAJOR VERSION
import React from 'react';
import ListenSolfegeIDTemplate from '../ListenSolfegeIDTemplate';

// Exercise Configuration - Do-La range in F Major (Level 3)
const EXERCISE_CONFIG = {
  id: 'lvl3_solfege_listening2',
  title: 'Level 3 Solfege Listening #2',
  totalQuestions: 6,
  notes: ['F4', 'G4', 'A4', 'Bb4', 'C5', 'D5'], // F Major: Do-La range
  ...
  keySignature: 'F' // Key signature with one flat
};

// Question Bank - All patterns transposed to F Major
const QUESTION_BANK = [
  // Question 1 - Original patterns with Do-Sol focus (F Major)
  {
    patterns: [
      [
  ...
  // Question 2 - La emphasis with stepwise patterns (F Major)
  {
    patterns: [
      [
        { pitch: 'F4', syllable: 'Do', duration: 'q' },
  ...
  // Question 3 - Skip patterns with syncopation (F Major)
  {
    patterns: [
      [
        { pitch: 'F4', syllable: 'Do', duration: 'q' },
  ...
  // Question 4 - Repeated patterns with variations (F Major)
  {
    patterns: [
      [
        { pitch: 'F4', syllable: 'Do', duration: 'q' },
  ...
  // Question 5 - Scalar passages with rhythm variations (F Major)
  {
    patterns: [
      [
        { pitch: 'F4', syllable: 'Do', duration: 'e' },
      ...
      [
        ...
        { pitch: 'F4', syllable: 'Do', duration: 'e' },
        { pitch: 'G4', syllable: 'Re', duration: 'e' },
        { pitch: 'A4', syllable: 'Do', duration: 'q' },
        { pitch: null, syllable: null, duration: 'q', isRest: true },   
        { pitch: 'Bb4', syllable: 'Mi', duration: 'h' },
        { pitch: 'C5', syllable: 'Sol', duration: 'h' },
      ],
      [
        { pitch: 'F4', syllable: 'Do', duration: 'e' },
  ...
  // Question 6 - Mixed intervals and leaps (F Major)
  {
    patterns: [
      [
        { pitch: 'F4', syllable: 'Do', duration: 'q' },
...
const Lvl3SolfegeListening2 = ({ onClose }) => {
  React.useEffect(() => {
...
export default Lvl3SolfegeListening2;