...
const generatePatternLevel4 = (excludePatternIndex = -1) => {
   ...
   * 3. Must include Sol-La-Ti-Do (D5-E5-F#5-G5) as four consecutive QUARTER NOTES with no rests between them
   ...
   * 8. Every pattern must start and end on Do (G4)
   ...
   * 13. Must include La (E5) at least once in each pattern
   ...
   * 17. Must include Ti (F#5) at least once in each pattern
  ...
  const patterns = [
    // Pattern 1 - Following ALL Level 4 rules including the new Do-Sol skip requirement
    {
      notes: [
        ...
        { pitch: 'F#5', syllable: 'Ti', duration: 'h' },
    ...
    // Pattern 2 - Second exercise with different Do-Sol skip placement
    {
      notes: [
        ...
        { type: 'rest', duration: 'q' },
        { pitch: 'A4', syllable: 'Re', duration: 'h' },
        { pitch: 'G4', syllable: 'Do', duration: 'q' },
...
const Lvl4SolfegeID3 = ({ onClose }) => {
  const config = {
    title: 'Level 4 Solfege Identification',
    subtitle: 'Solfege: Do-Do • Rhythm: Quarter, Half, and Eighth Notes • Quarter Rests • Key: G Major • Dynamics: f/p',
    ...
    getLinePosition: (pitch, stave) => {
      switch(pitch) {
        ...
        case 'f#/5': return stave.getYForLine(2);
        case 'g/5': return stave.getYForLine(1.5);
