...
export const FirebaseAuthProvider = ({ children }) => {
  ...
  const signInWithMicrosoft = async () => {
    ...
    try {
      ...
      if (!approved) {
        ...
        const notApprovedError = new Error("Your email is not registered for access. Contact your administrator");
        notApprovedError.code = 'auth/not-approved';
        console.log('Email not approved');
        throw notApprovedError;
      }
  ...
  const sendMagicLink = async (email) => {
    ...
    if (!approved) {
      const notApprovedError = new Error("This email is not registered. Contact your administrator");
      notApprovedError.code = 'auth/not-approved';
